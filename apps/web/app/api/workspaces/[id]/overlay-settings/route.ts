...
export const GET = async (
  ...
  return apiSuccess({
    ...
    amazonMarketplace: settings.amazonMarketplace,
    ebayCampaignId: settings.ebayCampaignId,
    walmartAffiliateId: settings.walmartAffiliateId,
    bestBuyAffiliateId: settings.bestBuyAffiliateId,
    etsyAwinAffiliateId: settings.etsyAwinAffiliateId,
    affiliateFallbackOrder: settings.affiliateFallbackOrder,
    aiProductDiscoveryEnabled: settings.aiProductDiscoveryEnabled,
    autoDiscoverOnApprove: settings.autoDiscoverOnApprove,
    requirePaapiForAmazon: settings.requirePaapiForAmazon,
